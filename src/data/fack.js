const fackData =[
...

    {
      ...
      {
        courses: 'JavaScript',
        history:'If you do not want to be a Full Stack Web developer, but still want to work on web development, then you may have to start off with JavaScript. It is important to know how JavaScript works and understand the fundamental concepts behind JavaScript The course will teach you what are closures, IIFEs, Prototypal inheritances, etc. It will also help you to debug your project from your own home. You will be able to understand the source code of frameworks in JavaScript and build your own JavaScript library or framework. ',
        img:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRaKuLgsel-1tFC1myiPqhiwVm883cpYdiEgg&usqp=CAU',
        Death:1910,
        Comedies:'Dramatic plays ',
        country: 'USA',
        free:800,
        key:'sfdfhghg'
      },

      {
        ...
        history:'If you want to amp up your game and build reactive and amazing web applications, then you have to master Angular 6. Angular 6 is a successor of the once-popular Angular.js and it will help you understand directives, components, routings, HTTP access, etc.',
        img:'https://i.ytimg.com/vi/Fdf5aTYRW0E/maxresdefault.jpg',
        Death:1849,
        Comedies:'The Works of the Late Edgar Allan Poe ',
        country: 'CHINA',
        free:900,
        key:'sfdfhghg'
      },
      ...
      {
        courses: 'Redux and React',
        history:'Redux and React are two major areas that any app developer should put their emphasis on. If you are someone who wants to make your own app or want to work for a company and build an app, then make Redux and React your friend After going for a course in React and Redux, you can learn how to develop different apps which gets its support from Webpack, ES6 and NPM. It will help you understand the core behind how React components are built and about the different structure-based applications of Redux.',
        img:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWoq_GhZEa_TzrluLYlUxV660JDKfDngXCgg&usqp=CAU',
        Death:1936,
        Comedies:'The Phoenix on the Sword',
        country: 'USA',
        free:1200,
        key:'sfdfhghg'
      },
...

      {
        ...
        history:'If you wish to build real-world network-based applications, then Node.js can be a great start. By mastering Express, MongoDB, Mocha and other such software, you will be able to develop, test and finally deploy amazing production applications in real-tiYou need to master these platforms first before you can take a turn to become a professional Node developer. Node is a vast field and you can expect to face a lot of challenges. Courses on Node.js will help you jump over these obstacles and hone your skills in Node.js.',
        img:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDqpcoeXfymqiw4c8pi3vigfNM7IGi-z9wLw&usqp=CAU',
        Death:1936,
        Comedies:'The Big Drunk Draf',
        country: 'INDIA',
        free:1006,
        key:'sfdfhghg'
      },
